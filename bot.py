...
def run_bot_thread(user_folder):
    ...
    # Filter tokens based on user_type
    # user_type: 1 = main user IDs, 2 = pages, 3 = both
    # For simplicity this demo just uses provided tokens for all types.
    # You can extend this to fetch page tokens separately if needed.
